function validate() {
    ...
    if (pass1.length < 8) {
        alert("Please set the first password to be longer than 8 characters")
    } else if (pass2.length < 8) {
        alert("Please set the second password to be longer than 8 characters")
    } else if (pass1 != pass2) {
        alert("The two passwords are different")
    } else {
        alert("The two passwords are the same")
    }
}
